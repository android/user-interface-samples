...
public class SplitActivityBase extends AppCompatActivity
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mViewBinding.launchB.setOnClickListener(
                (View v) -> startActivity(new Intent(this, SplitActivityB.class)));
        mViewBinding.launchBAndC.setOnClickListener(
                (View v) -> {
        ...
        mViewBinding.launchE.setOnClickListener(
                (View v) -> startActivity(new Intent(this, SplitActivityE.class)));
        mViewBinding.launchF.setOnClickListener(
                (View v) -> startActivity(new Intent(this, SplitActivityF.class)));
        mViewBinding.launchFPendingIntent.setOnClickListener(
                (View v) -> {
                    try {
    ...
    void updateCheckboxesFromCurrentConfig() {
        ...
        mViewBinding.finishBCCheckBox.setChecked(
